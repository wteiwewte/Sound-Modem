...
import pulseaudio.defs as defs
import pulseaudio.types as types
...
library.pa_simple_new.argtypes         = [ ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int, ctypes.c_char_p, ctypes.c_char_p, ctypes.POINTER(types.pa_sample_spec), ctypes.POINTER(types.pa_channel_map), ctypes.POINTER(types.pa_buffer_attr), ctypes.POINTER(ctypes.c_int) ] 
